...
const Client     = require('./service/irc/client');
const Repository = require('./service/irc/repository');
const log4js     = require('log4js');
const logger     = log4js.getLogger('core-plugins-hw-arduino-home.IrcAgent');

module.exports = class IrcAgent {
  constructor(config) {
